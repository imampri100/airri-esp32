...
namespace irrigation
{
    ...
    void SensorLogHandler::handleGetSensorLogs()
    {
        ...
        for (const SensorLog &log : logs)
        {
            JsonObject item = array.createNestedObject();
            item["id"] = log.id;
            item["createdAt"] = log.createdAt.value();
            item["soilMoisture"] = log.soilMoisture;
            item["airHumidity"] = log.airHumidity;
            item["airTemperature"] = log.airTemperature;
            item["lightIntensity"] = log.lightIntensity;
            item["isIrrigationRun"] = log.isIrrigationRun;
        }
        ...
        SerialLogger::info(
            "GET /api/logs/sensor lastId=" + String(lastId) +
            " limit=" + String(limit) +
